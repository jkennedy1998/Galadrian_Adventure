...
public class Map {
    ...
    public static void initializeMaps(){
        ...
        boards.get(0).findNonWallOnGrid(10,0,0).link = boards.get(1).findNonWallOnGrid(3,9,0);
        boards.get(1).findNonWallOnGrid(3,9,0).link = boards.get(0).findNonWallOnGrid(10,0,0);
        boards.add(getBoard("yaun-ti cave t"));
        boards.get(1).findNonWallOnGrid(4,0,0).link = boards.get(2).findNonWallOnGrid(13,11,0);
        boards.get(2).findNonWallOnGrid(13,11,0).link = boards.get(1).findNonWallOnGrid(4,0,0);
