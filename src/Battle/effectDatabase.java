...
//    public static void Name of effect(){ //id number of the effect
//        effectData[0] = "Name of the effect to be displayed as a String"; (should work as
...
//    }
    ...
    public static void meditation(){ //2
        ...
        public static void burning(){ //3
        effectData[0] = "burning";
        effectData[1] = ""+(-5);
        effectData[2] = ""+(3);
        effectData[3] = ""+(.5);
        effectData[4] = ""+(0);
